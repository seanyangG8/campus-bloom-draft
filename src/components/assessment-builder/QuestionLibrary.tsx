...
export function QuestionLibrary() {
  const { addQuestion } = useAssessmentBuilder();
    ...
    <div className="flex flex-col h-full bg-card rounded-xl border shadow-card overflow-hidden">
      ...
      <ScrollArea className="flex-1">
        <div className="p-3 space-y-4">
          ...
          {/* Submission section */}
          <div>
            <h4 className="text-xs font-semibold text-amber-600 mb-2 px-1">
              ...
              {submissionTypes.map((qt) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      'flex items-start gap-3 p-3 rounded-lg border cursor-grab transition-all',
                      'bg-background hover:bg-amber-50/50 hover:border-amber-300/50',
                      'active:cursor-grabbing active:scale-[0.98]'
                    )}
                  >
                    <div className="flex items-center gap-2 shrink-0">
