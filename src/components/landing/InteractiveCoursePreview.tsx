  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-4 bg-card rounded-xl shadow-lg border overflow-hidden flex flex-col">
        {/* Browser Bar */}
        <div className="h-8 bg-muted/80 grid grid-cols-[1fr_auto_1fr] items-center px-3 gap-3 border-b shrink-0 min-w-0">
          <div className="flex items-center gap-2 min-w-0 justify-start">
            ...
            <div className="bg-background/60 rounded px-2 py-0.5 text-[10px] text-muted-foreground truncate max-w-[50%] sm:max-w-[320px] min-w-0">
